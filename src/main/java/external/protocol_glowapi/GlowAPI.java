package external.protocol_glowapi;
...
import external.protocol_glowapi.listeners.EntityMetadataListener;
import external.protocol_glowapi.listeners.PlayerJoinListener;
import external.protocol_glowapi.listeners.PlayerQuitListener;
import external.protocol_glowapi.packetwrappers.WrapperPlayServerEntityMetadata;
import external.protocol_glowapi.packetwrappers.WrapperPlayServerScoreboardTeam;
import external.protocol_glowapi.packetwrappers.WrapperPlayServerScoreboardTeam.Modes;
import external.protocol_glowapi.packetwrappers.WrapperPlayServerScoreboardTeam.NameTagVisibility;
import external.protocol_glowapi.packetwrappers.WrapperPlayServerScoreboardTeam.TeamPush;
...
public class GlowAPI {
    ...
    public static GlowAPI getPlugin() {
        ...
        return GlowApiProvider.getProtocolLibApi();
    }

    public void onEnable() {
        final PluginManager pluginManager = Bukkit.getPluginManager();
        pluginManager.registerEvents(playerJoinListener, Main.main);
        pluginManager.registerEvents(playerQuitListener, Main.main);
