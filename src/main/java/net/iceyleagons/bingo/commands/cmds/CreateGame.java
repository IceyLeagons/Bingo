...
public class CreateGame {
    ...
    @CommandManager.Cmd(cmd = "create", args = "<max-players> <amount-of-teams> <starting-player-count>",
    ...
    public static CommandManager.CommandFinished onCommand(CommandSender sender, Object[] args) {
        ...
        Integer amountOfPlayers = (Integer)args[0];
        Integer starting = (Integer)args[0];
